...
public class Bugingi implements BaseInterface {
    @Override
    public synchronized SendMessage onUpdateReceived(Update update) {
        try {
            ...
            int ind = str.indexOf(" <h2 style=\"font-size: 24px; color: red\">");
            int indLast = str.indexOf("<h2 style=\"font-size: 24px; color: green\">");
